...
- (void)initUI {
  ...
  //  [self.diaper configImg:diaperImg withTitle:@"纸尿裤"];
    [self.diaper configImg:diaperImg withTitle:@"纸尿裤" widthSize:CGSizeMake(40, 60)];
    [self.milkPower configImg:milkImg withTitle:@"奶粉" widthSize:CGSizeMake(40, 60)];
    [self.food configImg:foodImg withTitle:@"辅食" widthSize:CGSizeMake(40, 60)];
    ...
    [self.iconReal configImg:realImg withTitle:@"正品保障" widthSize:CGSizeMake(50, 60)];
    [self.iconPlane configImg:planeImg withTitle:@"海外直采" widthSize:CGSizeMake(50, 60)];
    [self.iconExpress configImg:expressImg withTitle:@"保税区直邮" widthSize:CGSizeMake(50, 60)];
    [self.iconSeven configImg:sevenImg withTitle:@"辅食" widthSize:CGSizeMake(50, 60)];
}
