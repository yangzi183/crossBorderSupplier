...
- (void)drawDashedBorder
{
	...
	UIColor *lineColor = _borderColor ? _borderColor : [CROCommonAPI colorWithHexString:@"#cecece"];
    ...
    //CGPathAddArc(path, NULL, frame.size.width + 20, frame.size.height - cornerRadius, cornerRadius, 0, M_PI_2, NO);
